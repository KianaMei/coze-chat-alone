...
接口描述​
  * 你可以查看当前账号创建和加入的工作空间，包括个人账号的工作空间和企业/团队账号的工作空间。​


  * 在扣子企业版或团队版中，你可以在 Query 中指定 enterprise_id，查看该企业或团队中，当前账号创建或加入的所有工作空间。​


  * 你可以在 Query 中同时指定 user_id 和 coze_account_id，查看指定用户在指定组织下加入的工作空间。这里的组织可以是企业或团队中的某个组织，也可以是个人版账号。​
...
查看当前账号在指定团队或企业中的工作空间（不含个人空间）​| 必选​| 不传​| 不传​  
查看指定用户在指定组织的工作空间（不含个人空间）​| 不传​| 必选​| 必选​  
​
注意
暂不支持[第三方渠道应用](https://www.coze.cn/open/docs/dev_how_to_guides/channel_integration_overview)调用此 API。​
​
基础信息​
​
请求方式​| GET  
...
权限​| listWorkspace​确保调用该接口使用的访问令牌开通了listWorkspace权限，详细信息参考[鉴权](https://www.coze.cn/docs/developer_guides/authentication)。​  
...
enterprise_id​| String​| 可选​| volcano_2105850***​| 企业 ID，企业 ID 的获取方法如下：​切换到企业中，并在左侧导航栏中单击企业管理，URL 中 enterprise 参数后的数字就是enterprise_id。例如，在 URL https://www.coze.cn/enterprise/volcano_2105850***/中，volcano_2105850*** 就是 enterprise_id。​
  * 如果指定 enterprise_id，则查询对应 EnterpriseId 中，当前账号创建或加入的所有工作空间。​


  * 如果不指定 enterprise_id，则查询当前账号创建和加入的所有工作空间，包括个人账号的工作空间和企业/团队账号的工作空间。​

说明仅扣子团队版或企业版套餐中的用户支持该参数。个人免费版和个人进阶版不支持该参数。​​  
user_id​| String​| 可选​| 38509118307***​| 扣子用户 ID，用于查询特定用户的工作空间信息。​你可以单击扣子左下角的头像，选择账号设置，在页面底部查看扣子用户的 UID。​​​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27350%27%20height=%27341.90751445086704%27/%3e)![](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzUwIiBoZWlnaHQ9IjM0MS45MDc1MTQ0NTA4NjcwNCIgdmVyc2lvbj0iMS4xIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)​​说明如果同时指定 user_id 和 coze_account_id，则查询该用户在该组织下加入的工作空间。暂时不支持仅指定user_id 或仅指定coze_account_id。​​  
coze_account_id​| String​| 可选​| 38509118307***​| 扣子的组织 ID，用于查询特定组织的工作空间信息。​
  * 扣子个人版中，coze_account_id 即为 user_id。​


  * 扣子团队版和企业版中，coze_account_id 为组织 ID。你可以在组织管理 > 组织设置页面查看对应的组织 ID，或通过[查询组织列表](https://www.coze.cn/open/docs/developer_guides/list_organization) API 查询组织 ID。​
...
data​| Object of OpenSpaceData​| \​| 接口响应的业务信息。  
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
workspaces​| Array of OpenSpace​| \​| 用户创建或加入的空间列表。​  
...
返回示例
错误码
![](https://bat.bing.com/action/0?ti=97151251&Ver=2&mid=ec1e496a-a43d-40af-bf3b-9ffaac9289cd&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%96%87%E6%A1%A3%20-%20%E6%89%A3%E5%AD%90&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Flist_workspace&r=&lt=887&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=550081)
![](https://bat.bing.com/action/0?ti=97179855&Ver=2&mid=b6f9c75b-2d3d-49d3-98d7-f65f2a1d3a7d&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%96%87%E6%A1%A3%20-%20%E6%89%A3%E5%AD%90&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Flist_workspace&r=&lt=887&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=746804)
rangeDom