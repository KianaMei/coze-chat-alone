https://www.coze.cn/open/docs/developer_guides/read_variable
...
获取智能体或应用中设置的用户变量的值。​
接口说明​
通过[设置用户变量的值](https://www.coze.cn/open/docs/developer_guides/update_variable) API 设置变量值之后，可以通过本 API 查看智能体或应用中设置的用户变量的值。调用此 API 时可以查看指定变量的值，也可以将 keywords 指定为空，查看智能体或应用下的所有用户变量的值。如果输入的 keywords 在智能体或应用中不存在，扣子不会报错，但返回结果中不会包含相应的用户变量。​
限制说明​
  * 仅支持获取已发布 API、ChatSDK 和自定义渠道的智能体或应用中的用户变量的值。​


  * 用户变量按照 user_id \+ connector_uid \+ connector_id \+ bot_id 的组合进行隔离，因此在扣子开发平台站内设置的用户变量，在 API 渠道可能无法获取对应的值。不同渠道用户标识的规则存在差异，具体如下表所示。​


  * ​
参数​| 扣子开发平台站内​| API 渠道​| 自定义渠道​  
---|---|---|---  
user_id ​| 当前使用者的扣子用户 ID。​| API Token 生成者的 ID。​| 固定为 1。​  
connector_uid​| 当前使用者的扣子用户 ID。​| 用户在[发起对话](https://www.coze.cn/open/docs/developer_guides/chat_v3) 等 API 中输入的 user_id。​| 第三方平台的用户 ID，如飞书的 openId。​  
​
...
权限​| readVariable​确保调用该 API 使用的访问令牌开通了 readVariable 权限，详细信息参考[鉴权方式](https://www.coze.cn/docs/developer_guides/authentication)。​  
...
connector_id​| String​| 可选​| 1024​| 智能体或应用的发布渠道 ID 列表。目前支持如下渠道：​
  ...
  * 自定义渠道：自定义渠道 ID，获取方式可以参考 [渠道入驻概述](https://www.coze.cn/open/docs/dev_how_to_guides/channel_integration_overview)。需要保证使用自定义渠道的创建者的访问令牌来进行访问。​

  
connector_uid​| String​| 必选​| openAPI​| 查看指定用户 ID 的变量值。用户 ID 对应[执行工作流](https://www.coze.cn/open/docs/developer_guides/workflow_run) API 中 ext 字段中的 user_id。​  
...
data​| Object of GetVariableData​| -​| 用户变量数组。​  
detail​| Object of ResponseDetail​| -​| 返回详情。​  
​
GetVariableData​
​
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
items​| Array of KVItem​| [{ "value": "小王", "create_time": 0, "update_time": 0, "keyword": "name" }]​| 用户变量数组。​  
​
KVItem​
​
参数​| 类型​| 示例​| 说明​  
...
返回示例
错误码
![](https://bat.bing.com/action/0?ti=97151251&Ver=2&mid=e676543f-241b-4c6e-ac93-068e18989dd6&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%96%87%E6%A1%A3%20-%20%E6%89%A3%E5%AD%90&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fread_variable&r=&lt=975&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=988441)
![](https://bat.bing.com/action/0?ti=97179855&Ver=2&mid=e846c57f-184c-45c3-9385-b35b81074f58&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%96%87%E6%A1%A3%20-%20%E6%89%A3%E5%AD%90&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fread_variable&r=&lt=975&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=865384)
rangeDom