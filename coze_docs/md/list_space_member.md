https://www.coze.cn/open/docs/developer_guides/list_space_member
...
权限​| readMember​确保调用该接口使用的访问令牌开通了 readMember 权限，详细信息参考[鉴权方式](https://www.coze.cn/docs/developer_guides/authentication)。​  
接口说明​| 查看指定空间的成员列表。​  
​
请求参数​
Header​
...
参数​| 类型​| 是否必选​| 示例​| 说明​  
---|---|---|---|---  
workspace_id​| String​| 必选​| 736163827687053****​| 需要查看成员列表的空间 ID。​进入指定空间，空间页面 URL 中 space 参数后的数字就是 Space ID。例如https://www.coze.cn/space/736163827687053****，Space ID 为736163827687053****。​  
​
Query​
​
参数​| 类型​| 是否必选​| 示例​| 说明​  
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
data​| Object of OpenSpaceMemberListData​| \​| 返回的数据对象，包含空间成员列表和总数。​  
...
\--header 'Authorization: Bearer pat_FFTwAe4KB9GpaXCGoCjKbzt****'​
​
返回示例​
​
JSON
