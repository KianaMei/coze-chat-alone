https://www.coze.cn/open/docs/developer_guides/published_apps_list
...
查看指定工作空间的扣子应用列表。​
接口描述​
查看指定工作空间的应用列表，包含草稿状态的应用和已发布的扣子应用。​
  * 扣子个人版中，你只能查询你作为工作空间所有者的扣子应用。​


  * 扣子团队版和企业版中，你可以查看指定工作空间下的所有扣子应用。​
...
权限​| listApp​确保调用该接口使用的访问令牌开通了 listApp 权限，详细信息参考[鉴权方式](https://www.coze.cn/docs/developer_guides/authentication)。​  
接口说明​| 查看指定工作空间的扣子应用列表。​  
​
请求参数​
Header​
​
...
参数​| 类型​| 是否必选​| 示例​| 说明​  
---|---|---|---|---  
workspace_id​| String​| 必选​| 75123945629***​| 扣子应用所在的工作空间的 Space ID。Space ID 是工作空间的唯一标识。​进入指定工作空间，工作空间页面 URL 中 space 参数后的数字就是 Space ID。例如https://www.coze.cn/space/736163827687053****/bot，Space ID 为736163827687053****。​  
publish_status​| String​| 可选​| all​| 扣子应用的发布状态，用于筛选不同发布状态的扣子应用。枚举值如下： ​
  * all ：所有状态。 ​
...
connector_id​| String​| 可选​| 1024​| 渠道 ID，仅在 publish_status 为 published_online 或 published_draft 时需要设置。用于筛选该渠道下已发布的扣子应用，包括已发布的线上正式版本和已发布的草稿版本。​默认值为 1024，即默认获取 API 发布渠道下的最新版本。​扣子的渠道 ID 包括：​
  * 1024：API 渠道。​
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
data​| Object of OpenGetProjectData​| {"items":[{"id":"74876004423701****","name":"test","icon_url":"https://example.com/FileBizType.BIZ_BOT_APP/app1***.png","updated_at":1718289297,"description":"应用测试","is_published":true,"published_at":1718289297,"owner_user_id":"23423423****"}],"total":1}​| 返回的扣子应用列表数据，包含扣子应用的基本信息和总数。​  
code​| Long​| 0​| 调用状态码。0 表示调用成功，其他值表示调用失败，你可以通过 msg 字段判断详细的错误原因。​  
msg​| String​| ""​| 状态信息。API 调用失败时可通过此字段查看详细错误信息。​状态码为 0 时，msg 默认为空。​  
detail​| Object of ResponseDetail​| {"logid":"1234567890abcdef"}​| 包含请求的详细日志信息，用于问题排查和调试。​  
​
OpenGetProjectData​
​
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
items​| Array of AppSimpleInfo​| [ { "id": "751614225987***", "is_published": false, "updated_at": 1749994622, "owner_user_id": "32902037***", "name": "***", "description": "***", "icon_url": "https://example.com/FileBizType.BIZ_BOT_ICON/***" } ]​| 返回的扣子应用列表。​  
total​| Long​| 2​| 返回的扣子应用的数量。​  
​
AppSimpleInfo​
​
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
id​| String​| 74876004423701****​| 扣子应用的 ID。​  
name​| String​| test​| 扣子应用的名称。​  
icon_url​| String​| https://example.com/FileBizType.BIZ_BOT_APP/app1***.png​| 扣子应用图标的 URL。​  
folder_id​| String​| 752316125533***​| 应用所属的文件夹 ID。​  
updated_at​| Long​|  1718289297​| 扣子应用的最近一次更新时间。以 Unix 时间戳格式表示。单位为秒。​  
description​| String​| 应用测试​| 扣子应用的描述。​  
is_published​| Boolean​| true​| 扣子应用是否已发布。​
  * true 表示已发布。​
...
published_at​| Long​| 1718289297​| 扣子应用的最近一次发布时间。以 Unix 时间戳格式表示。单位为秒。​仅当扣子应用已发布时返回该值。如果扣子应用是未发布过的草稿版本，则该参数的值为空。​  
owner_user_id​| String​| 23423423****​| 扣子应用创建者的扣子用户 ID。​  
​
ResponseDetail​
​
参数​| 类型​| 示例​| 说明​  
...
返回示例
错误码
![](https://bat.bing.com/action/0?ti=97151251&Ver=2&mid=2fe454ac-0384-451d-a4a5-6ae652242c1d&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%89%A3%E5%AD%90%20-%20AI%20Agent%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC%E5%B9%B3%E5%8F%B0%20-%20%E6%89%A3%E5%AD%90%E7%94%A8AI%E9%87%8D%E5%A1%91%E7%94%9F%E4%BA%A7%E5%8A%9B%E4%B8%8E%E5%B7%A5%E4%BD%9C%E6%95%88%E7%8E%87&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fpublished_apps_list&r=&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=231948)
![](https://bat.bing.com/action/0?ti=97179855&Ver=2&mid=d20d8131-f75d-4838-ab72-7fb317e2e9ae&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%89%A3%E5%AD%90%20-%20AI%20Agent%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC%E5%B9%B3%E5%8F%B0%20-%20%E6%89%A3%E5%AD%90%E7%94%A8AI%E9%87%8D%E5%A1%91%E7%94%9F%E4%BA%A7%E5%8A%9B%E4%B8%8E%E5%B7%A5%E4%BD%9C%E6%95%88%E7%8E%87&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fpublished_apps_list&r=&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=228235)
rangeDom