https://www.coze.cn/open/docs/developer_guides/ui_builder_web_sdk
...
功能简介 ​
Web SDK 是一个轻量级 JavaScript 库，旨在帮助开发者快速将扣子平台上搭建的 AI 应用（包括用户界面和业务逻辑）快速、无缝地集成到网站或 Web 页面中。​
核心优势：​
  * 无缝集成： 将已发布的扣子应用作为独立组件嵌入 Web 页面。​


  * 开箱即用： 集成后，扣子应用的 UI 和逻辑无需二次开发即可运行。​
...
​
​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27500%27%20height=%27524.8815165876777%27/%3e)![](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTAwIiBoZWlnaHQ9IjUyNC44ODE1MTY1ODc2Nzc3IiB2ZXJzaW9uPSIxLjEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+)​
​
​
​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27500%27%20height=%27310.42654028436016%27/%3e)![](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTAwIiBoZWlnaHQ9IjMxMC40MjY1NDAyODQzNjAxNiIgdmVyc2lvbj0iMS4xIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)​
​
​
准备工作 ​
环境要求 ​
...
​
获取访问密钥 ​
访问密钥用于 Web SDK 的身份认证与鉴权。扣子提供多种类型的鉴权方式，你可以根据使用场景选择对应的鉴权方式：​
...
步骤一：发布并获取安装代码 ​
1.
将应用发布为 Web SDK，具体步骤请参见​发布应用为 Web SDK。​


2.
在扣子应用的编排页面单击右上角的版本记录图标，选择指定版本的更多图标，选择发布结果。 ​
...
​
初始化配置​
配置 Web SDK 的初始化参数，包括访问密钥、扣子应用 ID 和渲染的容器。​
​
参数​| 类型​| 是否必选​| 示例​| 说明​  
---|---|---|---|---  
...
appId​| String​| 必选​| 740849137970326****​| 扣子应用的 ID。在扣子应用编排页面的 URL 中，project-ide 参数之后的字符串就是 appId。​  
...
​
用户信息​
userInfo 参数用于配置和扣子应用对话的用户的信息，包含用户头像、昵称和用户 ID，用于在应用交互中标识用户。​
​
参数​| 类型​| 是否必选​| 示例​| 说明​  
---|---|---|---|---  
...
Chat SDK 和 Web SDK 均为扣子平台提供的 SDK，区别如下：​
  * 支持的应用类型不同​


  * Web SDK：仅支持扣子应用，且用户界面为 Web 端，不支持小程序端。​


  * Chat SDK：支持智能体和扣子应用两种类型，支持小程序端。​


  * 功能特性差异​


  * Web SDK：扣子应用发布 Web SDK 时，会将扣子应用的用户界面（UI）和业务逻辑完整打包发布，集成后可直接在网站中呈现应用的现成交互界面，开发者无需二次开发页面。​


  * Chat SDK：扣子应用发布 Chat SDK 时，仅包含智能体/扣子应用中的对话流、对话容器部分（Chatbot 类），不包含应用户界面，主要用于实现用户与 AI 智能体或应用的对话相关功能。​
...
常见问题
Chat SDK 和 Web SDK 有什么区别？
![](https://bat.bing.com/action/0?ti=97151251&Ver=2&mid=307ab337-a196-4cce-98e8-d474af06a9b9&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%89%A3%E5%AD%90%20-%20AI%20Agent%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC%E5%B9%B3%E5%8F%B0%20-%20%E6%89%A3%E5%AD%90%E7%94%A8AI%E9%87%8D%E5%A1%91%E7%94%9F%E4%BA%A7%E5%8A%9B%E4%B8%8E%E5%B7%A5%E4%BD%9C%E6%95%88%E7%8E%87&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fui_builder_web_sdk&r=&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=524390)
![](https://bat.bing.com/action/0?ti=97179855&Ver=2&mid=d95e054c-c323-4391-b43c-e0b51d1bd800&bo=1&sid=a6c3ee30d4c211f0966da1ab2d8de18c&vid=a6c3dd00d4c211f0a7ba75271dd5e1e5&vids=0&msclkid=N&uach=pv%3D19.0.0&pi=0&lg=zh-CN&sw=1280&sh=720&sc=24&nwd=1&tl=%E6%89%A3%E5%AD%90%20-%20AI%20Agent%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC%E5%B9%B3%E5%8F%B0%20-%20%E6%89%A3%E5%AD%90%E7%94%A8AI%E9%87%8D%E5%A1%91%E7%94%9F%E4%BA%A7%E5%8A%9B%E4%B8%8E%E5%B7%A5%E4%BD%9C%E6%95%88%E7%8E%87&kw=%E6%89%A3%E5%AD%90,%20Coze,%20AI%20Agent,%20%E6%99%BA%E8%83%BD%E5%8A%9E%E5%85%AC,%20%E5%8A%9E%E5%85%AC%E6%8F%90%E6%95%88,%20AI%E5%86%99%E4%BD%9C,%20PPT%E7%94%9F%E6%88%90,%20%E7%BD%91%E9%A1%B5%E5%BC%80%E5%8F%91,%20%E7%94%9F%E4%BA%A7%E5%8A%9B%E5%B7%A5%E5%85%B7&p=https%3A%2F%2Fwww.coze.cn%2Fopen%2Fdocs%2Fdeveloper_guides%2Fui_builder_web_sdk&r=&mtp=10&evt=pageLoad&sv=2&cdb=AQAQ&rn=555837)
rangeDom